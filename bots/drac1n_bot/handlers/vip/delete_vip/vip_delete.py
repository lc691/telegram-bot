...
from bots.drac1n_bot.keyboard.vip_tools import generate_delete_confirm_buttons
...
from db.vip_users.vip_deactivate import remove_vip
from db.vip_users.vip_status import check_vip_status, get_all_active_vip_users


async def vip_delete_start(client: Client, callback_query: CallbackQuery):
    admin_id = callback_query.from_user.id
    bot_name = getattr(client, "name", "drac1n_bot")
