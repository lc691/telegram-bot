...
from bots.dramaglow_bot.delivery.telegram.user.services.channel_repository import (
    delete_required_channel,
    load_required_channels,
    validate_required_channels,
)
from bots.dramaglow_bot.utils.channel_markup_factory import (
    generate_channel_list_markup,
    generate_channel_markup,
)
from configs.logging_setup import log
from db.chanel_management import add_user, discard_user
