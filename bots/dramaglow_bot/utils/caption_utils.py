...
def generate_full_caption(
    ...
    def clean_hashtags(tags: str, is_adult: bool):
        default = ["#dramashort", "#dramaglow", "#dramachina"]
        if is_adult:
    ...
    def build_source_block(code: str, label: str):
        ...
        source_text = (
            f'<b>{escape(label)}</b> | <a href="{main_url}">📚 LIST DRAMA</a>\n'
        )
        cta_text = ""
    ...
    if compact:
        sections.append(
            "\n<b>💠 VIP:</b> "
            '<a href="https://t.me/dramaglow_bot?start=vip">Akses</a> | '
            '<a href="https://t.me/dramaglow_bot?start=referral">Partner</a>\n'
        )
    else:
        sections.append(
            "<b>💰 Mau cuan cuma modal rebahan?</b>\n"
            '<a href="https://t.me/dramaglow_bot?start=referral">'
            "Gabung jadi partner promosi</a>\n\n"
            "<b>💠 AKSES VIP - TONTON BEBAS</b>\n"
            '<a href="https://t.me/dramaglow_bot?start=vip">Klik Disini</a>\n\n'
            "<b>🌐 VIP Manual:</b>\n"
            '<a href="https://t.me/c/3806648480/3">Transfer</a> | '
            '<a href="https://t.me/c/3871945880/3">Malaysia</a>\n\n'
            "<b>📖 PANDUAN & BANTUAN</b>\n"
            '📚 <a href="https://t.me/tutorialvip1/22">Panduan VIP</a>\n'
            "📞 Admin: @mimindcstv | @admischelia\n\n"
            "🚀 <b>Gabung Channel Diskusi</b>\n"
            '👥 <a href="https://t.me/dramaglowgrup">DCSTV GRUP</a>\n'
        )
