...
from bots.dramaglow_bot.constants.vip_source import VipSource
from bots.dramaglow_bot.keyboard.vip_tools import generate_vip_tools_markup
...
def register_vip_menu_handler(app: Client):
    @app.on_callback_query(filters.regex(r"^vip_tools:(glow|drac1n|utbk)$"))
