...
from bots.dramaglow_bot.services.vip_stats_service import get_vip_stats_message
...
def register_vip_stats_handler():
    return (
        r"^vip_stats:(glow|drac1n|utbk|vip|donation):(vip|donation):\d+$",
        handle_vip_stats,
    )


from bots.dramaglow_bot.utils.vip_donation_chart import render_donation_chart
from db.stats.donation_aggregates import get_vip_donation_per_day
