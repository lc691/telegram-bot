...
from apps.drac1n_bot.delivery.telegram.admin.leaderboard.handlers.commands import register_leaderboard_command_handler
from apps.drac1n_bot.delivery.telegram.admin.leaderboard.handlers.callbacks import register_leaderboard_callback
