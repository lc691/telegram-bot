...
from apps.drac1n_bot.handlers.vip.extend_vip.vip_build_user_extend import (
    PER_PAGE,
    build_user_extend_markup,
)
from apps.drac1n_bot.keyboard.vip_tools import (
...
from database.vip_users.vip_extend import extend_or_activate_vip
