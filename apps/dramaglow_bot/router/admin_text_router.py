...
from apps.dramaglow_bot.handlers.admin.add.admin_add import handle_regular_step
from apps.dramaglow_bot.handlers.admin.remove.admin_remove import (
    handle_admin_remove_step,
)
from apps.dramaglow_bot.handlers.admin.source.add_source_step import (
    handle_add_source_step,
)
from apps.dramaglow_bot.handlers.admin.update.admin_update import (
    handle_admin_update_step,
)
from apps.dramaglow_bot.ui.dashboard import send_dashboard
