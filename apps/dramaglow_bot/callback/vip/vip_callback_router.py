...
from shared.utils.vip_state_manager import VipStateManager  # pastikan path sesuai

from .exact_routes import vip_exact_routes
from .regex_routes import vip_regex_routes
...
def register_vip_router(app: Client):
    ...
    async def handle_vip_routes(client: Client, callback_query: CallbackQuery):
        ...
        state = VipStateManager(user_id, source_bot="glow")
