...
from ..vip.queries_user import ensure_user_exists, get_active_vip_row
from ..vip.queries_vip import count_user_purchases, insert_vip_log, upsert_vip_user
from ..vip.validators import calculate_total_duration
from ..vip.vip_date_logic import calculate_dates
