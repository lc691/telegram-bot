...
from apps.caridrama_bot.commands.cari_commands import get_cari_commands
from apps.dcst_mbot.commands.dcst_commands import get_dcst_commands
from apps.drac1n_bot.commands.drac1n_commands import get_drac1n_commands
from apps.dramaglow_bot.commands.glow_commands import get_glow_commands
